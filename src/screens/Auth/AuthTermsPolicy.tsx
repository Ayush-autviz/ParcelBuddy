...
type AuthTermsPolicyScreenNavigationProp = StackNavigationProp<AuthStackParamList, 'AuthTermsPolicy'>;

const AuthTermsPolicy: React.FC = () => {
  const navigation = useNavigation<AuthTermsPolicyScreenNavigationProp>();
...
export default AuthTermsPolicy;
